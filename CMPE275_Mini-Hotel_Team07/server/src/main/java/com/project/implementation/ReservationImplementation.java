...
//        reservationObject.setReservation_id(0);
       ...
       // Integer reservation_id = reservationObject.getReservation_id();
        ...
        String body = "Hello "+guestObject.getGuest_name()+
                ...
                "please <a href=\'http://52.53.255.195:8080/CmpE275Team07Fall2015TermProject/v1/cancelReservation?reservation_token="+token_no+"\'>Click Here</a><br></br>--<i>Express Hotel</i>";
